...
public class DataEventManagerTest {
  ...
  public void perNodeDataEventHandlerTest() throws InterruptedException {
    ...
    UpdateNodeDataEventHandler juliet =
  ...
  public void sharedDataEventHandlerTest() throws InterruptedException {
    ...
    UpdateSharedDataEventHandler alice =
  ...
  public void metricRegistryTest() {
    ...
    Assert.assertEquals(
        1, registry.getGauges().get(DataEventConstants.PER_NODE_DATA_SUBSCRIBERS_SIZE).getValue());
    Assert.assertEquals(
        0,
        registry
            .getGauges()
            .get(DataEventConstants.PER_NODE_DATA_SUBSCRIBERS_QUEUE_SIZE)
            .getValue());
    Assert.assertEquals(
        1, registry.getGauges().get(DataEventConstants.SHARED_DATA_SUBSCRIBERS_SIZE).getValue());
    Assert.assertEquals(
        0,
